...
func TestDepBotsRustDependabot(t *testing.T) {
	...
	plan, err := render.BuildRecipe(l, []string{"base-layout", "dep-bots-rust"},
		answers.Answers{"repo_name": "demo", "description": "a demo service", "module_path": "github.com/acme/demo", "provider": "github", "dep_bot": "dependabot"})
...
func TestDepBotsRustRenovate(t *testing.T) {
	l := module.NewFSLoader(keel.BuiltinFS)
	plan, err := render.BuildRecipe(l, []string{"base-layout", "dep-bots-rust"},
		answers.Answers{"repo_name": "demo", "description": "a demo service", "module_path": "github.com/acme/demo", "provider": "github", "dep_bot": "renovate"})
	require.NoError(t, err)
